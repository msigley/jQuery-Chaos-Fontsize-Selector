...
c.endsWith("px")){var d=a.getFontsize();a.css("line-height",parseInt(c,10)/d)}a.data("fixed-line-height",!0);return this}};b.fn.hyphenateWords=function(a){var c=b(this);a?c.css({hyphens:"auto","word-break":"break-word"}):c.css({hyphens:"manual","word-break":"normal"});return this}})(jQuery);String.prototype.endsWith||(String.prototype.endsWith=function(b,a){var c=this.toString();if(void 0===a||a>c.length)a=c.length;a-=b.length;c=c.indexOf(b,a);return-1!==c&&c===a});
String.prototype.trim||function(){var b=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(b,"")}}();
